...
def get_nearest_original(src_points, candidates, k_neighbors=3):
...
def nearest_neighbor_original(gdf1, return_dist=False):
    ...
    closest, dist = get_nearest_original(src_points=first_radians, candidates=second_radians)
